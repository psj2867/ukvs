...
class SimpleLogger {
  ...
  static DEFAULT_MIDDLE_WARE = (levelValue, m, ...args) => {
    m(...args);
  };
  constructor(level = SimpleLogger.DEFAULT_LOG_LEVEL) {
    this.level = level;
    this.middleware = SimpleLogger.DEFAULT_MIDDLE_WARE;
  }
  get level() {
  ...
  trace(...args) {
    this.apply(SimpleLogger.LOG_LEVEL.TRACE, console.debug, ...args);
  }
  debug(...args) {
    this.apply(SimpleLogger.LOG_LEVEL.DEBUG, console.debug, ...args);
  }
  info(...args) {
    this.apply(SimpleLogger.LOG_LEVEL.INFO, console.info, ...args);
  }
