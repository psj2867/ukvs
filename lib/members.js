...
export class MemberManager {
  ...
  async init() {
    ...
    this.members.onConnMember((type, id, member) => {
      if (this.state == "quit" || type == "quit" || type == "clean") {
...
export class Members {
   ...
   * @param {(type:'connect'|'open'|'stateChange'|'disconnect'|'changeAlive'|'clean'|'quit', id:string, memeber:Connection, )=>void} h
   */
  onConnMember(h) {
